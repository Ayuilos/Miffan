...
fun rememberSharedPreferenceString(
    ...
    val prefs = remember {
        context.getSharedPreferences("miffan.preferences", Context.MODE_PRIVATE)
    }
    val stateFlow =
...
fun Context.writeStringPreference(key: String, value: String?) {
    getSharedPreferences("miffan.preferences", Context.MODE_PRIVATE).edit {
        putString(key, value)
    }
}

fun Context.readStringPreference(key: String, defaultValue: String? = null): String? {
    return getSharedPreferences("miffan.preferences", Context.MODE_PRIVATE).getString(key, defaultValue)
}
...
fun Context.readBooleanPreference(key: String, defaultValue: Boolean = false): Boolean {
    return getSharedPreferences("miffan.preferences", Context.MODE_PRIVATE).getBoolean(key, defaultValue)
}
